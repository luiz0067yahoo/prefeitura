...
class model{
    ...
    public  function find()
      {
        try{
            ...
            $title=array();
			$recordsCount=0;
            $result_count=DAOquerySelect($this->table,array("count(".$this->table.".".self::id.")"),$this->joins,$this->params,$this->groups,$this->having,$this->orders,null);
			if(isset($result_count["data"])){
                $recordsCount=($result_count["data"][0][0]);
			}
    ...
    {   
        ...
        try{
    	    ...
    	    $result=DAOquerySelectById($this->table,$this->fields,$this->joins,$this->params[self::id]);
